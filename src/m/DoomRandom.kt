...
//
//-----------------------------------------------------------------------------
internal class DoomRandom : IRandom {
    ...
    override fun P_Random(): Int {
        ...
        return rndtable[prndindex].toInt()
    }
    ...
    constructor(SLY: ISyncLogger?) {
        this.SLY = SLY
    }

    private val SLY: ISyncLogger?
